...
import {
  NAIJADEVS_DAO_ABI,
  NAIJADEVS_DAO_CONTRACT_ADDRESS,
  NAIJADEVS_NFT_ABI,
...
export default function Home() {
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any NaijaDevs NFTs. <br />
  ...
  return (
    <div>
      <Head>
        <title>NaijaDevs DAO</title>
        <meta name="description" content="NaijaDevs DAO" />
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            Your NaijaDevs NFT Balance: {nftBalance}
            <br />
        ...
        <div>
          <img className={styles.image} src="/naijadevs/0.svg" />
        </div>
      </div>
